...
typedef struct S1SetupFailure {
	ProtocolIE_Container_6551P42_t	 protocolIEs;
	/*
...
extern asn_SEQUENCE_specifics_t asn_SPC_S1SetupFailure_specs_1;
extern asn_TYPE_member_t asn_MBR_S1SetupFailure_1[1];
