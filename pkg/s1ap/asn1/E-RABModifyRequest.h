...
typedef struct E_RABModifyRequest {
	ProtocolIE_Container_6551P14_t	 protocolIEs;
	/*
...
extern asn_SEQUENCE_specifics_t asn_SPC_E_RABModifyRequest_specs_1;
extern asn_TYPE_member_t asn_MBR_E_RABModifyRequest_1[1];
