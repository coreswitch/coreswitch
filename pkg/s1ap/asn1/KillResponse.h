...
typedef struct KillResponse {
	ProtocolIE_Container_6551P70_t	 protocolIEs;
	/*
...
extern asn_SEQUENCE_specifics_t asn_SPC_KillResponse_specs_1;
extern asn_TYPE_member_t asn_MBR_KillResponse_1[1];
