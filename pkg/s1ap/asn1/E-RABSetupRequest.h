...
typedef struct E_RABSetupRequest {
	ProtocolIE_Container_6551P12_t	 protocolIEs;
	/*
...
extern asn_SEQUENCE_specifics_t asn_SPC_E_RABSetupRequest_specs_1;
extern asn_TYPE_member_t asn_MBR_E_RABSetupRequest_1[1];
